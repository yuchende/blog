...
public class ArticleAction extends ActionSupport {
	...
	public String findAll() {
		...
		/*
		 * for (Article ar : list) { System.out.println(ar.toString()); }
	...
	public String findByID() {
		...
		/*
		 * System.out.println("-------articleVar"); System.out.println(articleVar);
		 * System.out.println("-------articleVar"); System.out.println("--------av");
		 * System.out.println(av.getVarity()); for(ArticleDes avv:av.getSet() ) {
	...
	public String main() {
		...
		ActionContext.getContext().getSession().put("a_v", res);

		/*
		 * System.out.println("输出解析结果"); for(ArticleVarity av:res) {
		 * System.out.println("["+av.getVarity()+"]"); for(ArticleDes ad:av.getSet()) {
		 * System.out.print(ad.getTitle()+"|||"); } System.out.println(); }
		 */
		System.out.println("回函数执行完");
		return "mainJSP";
	}
